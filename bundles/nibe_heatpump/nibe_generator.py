...
HEADER = "Divisors\t\t1\t1\t10\t10\t10\t10\t10\t10\t100\t1\t10\t10\t10\t1\t1\t10\t1\t1\t1\t1\t10\t10\t10\t10\t10\t10\t10\t10\t10\t10\t10\t10\t1\t1"
...
class DaySimulator:
    def __init__(self, date_str, outdoor_avg, outdoor_amp, is_post_fix, seed):
        ...
        if is_post_fix:
            self.dm_loss_per_min = int(2 + cold * 0.4)   # good flow
            self.dm_gain_per_min = 25
    ...
    def step(self, tick):
        ...
        bt17 = bt25 - 30 + self.rng.randint(-10, 10)
        bt28 = clamp(bt1 + self.rng.randint(-8, 8), bt1 - 10, bt1 + 10)
